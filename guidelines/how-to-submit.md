...
※Github：チームでのソースコードのバージョン管理サービスです。JPHACKSでは、アイデアやプレゼンスキルだけではなく、ソフトウェア実装力についても審査の対象とします。
※DEVPOST：ハッカソンでの開発物をポートフォリオとして掲載できるサービスです。アイデアやDEMO映像を掲載し、そちらを審査の対象とします。

## 開発から提出の流れ

1. [GithubのJPHACKSオフィシャルアカウントからのメンバー招待の確認と承認](#section1)
2. [Github上にてチームリポジトリの確認](#section2)
3. [Githubリポジトリの設定(公開か非公開かの設定)](#section3)
4. [Github開発製品の登録・README.mdの完成](#section4)
